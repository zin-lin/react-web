          ...
          <NativeDialog Id = "UserError" >
           ...
           <div style={{width:'100%', alignContent:"center", alignItems:"center", flex:"auto", flexDirection:"column"}}>
               ...
               <p style={{marginLeft:41, alignSelf:"center", textAlign:"center"}}>Your Password <Fa icon={faLock}/> </p>
                ...
                <button className="invisible responsive" style={{boxShadow:"none", color:"#43e0d0"}}> <Fa color="#ddd" size="1x" icon = {faRedo} style={{marginRight:7}}/>Dun Have an Account?</button></div>


                <Link to ="/sign-up"><button className="green centered padded2" style={{flex:"auto", minWidth:'80%', marginTop:5}}>
